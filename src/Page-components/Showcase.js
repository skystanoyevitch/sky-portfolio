		...
		<div className="">
			...
			<div className="bg">
				...
				>
					...
					<p className="text-center font-poppins text-xl leading-7 text-gray-700 xl:text-3xl xl:tracking-wide xl:leading-snug md:mt-4 md:px-10 md:pb-16 xl:pb-32 xl:px-40">
