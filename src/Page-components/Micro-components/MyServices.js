			...
			<section className="relative w-full xl:h-2/4 bg-primary">
				<div className="text-secondary p-8 md:px-16 lg:p-0">
					<div className="mx-auto h-full">
						...
						<div className="flex flex-col divide-y-2 divide-secondary xl:divide-y-0 xl:divide-x-2 xl:divide-secondary items-center md:pt-6 xl:p-0 xl:pt-16 md:pb-16 xl:space-y-0 xl:flex xl:flex-row xl:items-center text-center xl:h-2/3 xl:justify-center">
							<div className="xl:max-w-3xl pt-10 xl:pt-0 pb-10 xl:pb-0 xl:pr-24">
								<div className="flex justify-center">
									<MdOutlineDesignServices size={70} />
								</div>
								<h2 className="lg:pb-4 font-robotoThin font-semibold lg:tracking-widest text-3xl lg:text-4xl xl:text-5xl xl:pb-8">
									Design
								</h2>
								<p className="lg:max-w-lg lg:pt-4 xl:p-0 tracking-wider text-lg md:text-xl xl:text-2xl font-robotoThin leading-relaxed">
							...
							<div className="xl:max-w-3xl pt-10 xl:pt-0 xl:pl-24">
								...
								<p className="lg:max-w-lg lg:pt-4 xl:pt-0 tracking-wider text-lg md:text-xl xl:text-2xl font-robotoThin leading-relaxed">
