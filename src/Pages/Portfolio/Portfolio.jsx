						...
						return (
							<ul className="">
								...
								>
									...
									>
										<div className="text-center md:text-left md:pl-6 font-poppins text-lg md:text-3xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-cyan-500 via-indigo-500 to-[#e75d48]">
											{project.name}
										</div>
									</button>
								</li>
