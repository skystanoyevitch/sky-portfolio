					...
					{allProjects.map((project) => {
						return (
							<ul className="">
								<li
									key={project.id}
									className={` transition-transform w-80 z-0 md:w-full md:max-w-3xl hover:scale-105 hover:underline hover:underline-offset-8 hover:decoration-red-400 hover:decoration-4`}
								>
									<a
										href={project.link}
										target="blank_"
