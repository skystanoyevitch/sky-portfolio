  ...
  return (
    <>
      <section className="container mx-auto w-4/5 lg:w-2/3 md:flex md:flex-col md:items-center mb-20">
        <div className="md:flex md:flex-col md:justify-center md:w-1/2 xl:w-2/3 md:text-center md:mb-16">
        ...
        <div className="flex lg:flex-row lg:space-x-8">
          <div className="text-white text-center bg-gray-800 lg:p-8 rounded-md">
          ...
          <div className="text-white text-center bg-gray-800 lg:p-8 rounded-md">
            <h2 className="">CMS Design | Development</h2>
            <ul className="pt-8">
