			...
			<section className="container mx-auto w-4/5 lg:w-2/3 md:flex md:flex-col md:items-center mb-20">
				<div className="md:flex md:flex-col md:justify-center md:w-2/3 text-center mb-8 md:mb-16">
					...
					<p className="text-md font-light pt-4 lg:text-2xl tracking-wide text-[#9CCDE9]">
						I am a Software engineer in the field of technology
						specializing in the Front-End programming as well as
						UI/UX Design.
					</p>
				</div>
				<div className="flex flex-col space-y-8 md:space-y-6 lg:space-y-0 lg:flex-row lg:space-x-8 font-poppins">
					<div className="text-white text-center bg-gray-800 p-8 rounded-md shadow-md">
						<h2 className="text-md lg:text-lg font-bold bg-clip-text text-transparent bg-gradient-to-r from-cyan-500 via-indigo-500 to-[#e75d48]">
							UI | UX Design
						</h2>
						<ul className="pt-4">
					...
					<div className="text-white text-center bg-gray-800 p-8 rounded-md shadow-md">
						<h2 className="text-lg font-bold bg-clip-text text-transparent bg-gradient-to-r from-cyan-500 via-indigo-500 to-[#e75d48]">
							CMS Design & Dev
						</h2>
						<ul className="pt-4">
