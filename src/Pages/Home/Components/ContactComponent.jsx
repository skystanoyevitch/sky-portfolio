		...
		>
			<div className="mx-auto lg:max-w-lg text-center mt-12 lg:mt-24 lg:mb-10">
				...
				<p className="font-light tracking-wide text-[#9CCDE9] lg:text-2xl">
					Want to work together on a project or looking to hire a
					frontend dev? please don't hesitate to contact using the
					form below.
				</p>
			</div>
			<div className="container mx-auto pt-8 lg:pt-0 mt-12 lg:mt-0 md:h-full lg:max-w-md">
				<form
