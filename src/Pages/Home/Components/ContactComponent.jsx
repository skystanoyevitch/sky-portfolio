...
function ContactComponent() {
  ...
  return (
    <div
      className="p-8 container mx-auto md:w-3/4 lg:max-w-3xl mb-12 lg:mb-24"
      id="section-contact"
    >
        ...
        >
          ...
          <div className="md:flex md:justify-center">
            <button
              type="submit"
              value="submit"
              className="px-4 md:py-2 md:px-6 text-lg text-white font-poppins py-1 my-6 md:mx-0 rounded-md bg-gradient-to-r from-cyan-500 via-indigo-500 to-[#e75d48] transition ease-in-out hover:scale-125 duration-300"
            >
              Send
            </button>
          </div>
