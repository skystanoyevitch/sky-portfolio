				...
				<div className="text-center flex space-x-4 md:flex-row md:justify-center lg:space-x-10">
					<Link to={"/Contact"}>
						<div className="relative">
							<motion.button
								...
								whileTap={{ scale: 0.9 }}
								className="relative z-20 bg-mainOrange hover:bg-orange-700 text-white hover:text-white font-bold border border-gray-700 py-2 px-6 font-poppins text-md xl:text-xl xl:w-30 mt-8 xl:mt-10 md:mr-4 rounded-lg"
							>
								Contact
							</motion.button>
					...
					>
						<motion.button
							...
							whileHover="hover"
							whileTap={{ scale: 0.9 }}
							className="hover:bg-gray-700 hover:text-white bg-white py-2 px-6 font-poppins font-bold border border-gray-700  text-gray-700 text-md xl:text-xl xl:w-30 mt-8 xl:mt-10 md:mr-4 rounded-lg"
						>
							GitHub
						</motion.button>
						{/* <Toaster /> */}
